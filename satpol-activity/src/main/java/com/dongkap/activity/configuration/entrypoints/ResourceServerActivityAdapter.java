package com.dongkap.activity.configuration.entrypoints;
...
public class ResourceServerActivityAdapter extends ResourceServerConfigurerAdapter {

    private AccessDeniedHandler accessDeniedHandler;
    private AuthenticationEntryPoint authenticationEntryPoint;

    private String resourceId = ResourceCode.ACTIVITY;
    private String resourcePath = ResourceCode.ACTIVITY_PATH;
    
    public ResourceServerActivityAdapter() {}
    public ResourceServerActivityAdapter(AccessDeniedHandler accessDeniedHandler, AuthenticationEntryPoint authenticationEntryPoint) {
